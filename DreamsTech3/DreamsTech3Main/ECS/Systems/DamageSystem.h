...
#include "../Components/TransformComponent/HealthComponent.h"
...
public:
    ...
    void OnProjectileHitsPlayer(Entity projectile, Entity player)
    {
        ...
        {
            Logging::Logger::Log(
                "Projectile id: " + std::to_string(projectile.GetId()) + " collided with player id: " + std::to_string(
                    player.GetId()));
    ...
    void OnProjectileHitsEnemy(Entity projectile, Entity enemy)
    {
        ...
        {
            Logging::Logger::Log(
                "Projectile id: " + std::to_string(projectile.GetId()) + " collided with enemy id: " + std::to_string(
                    enemy.GetId()));
